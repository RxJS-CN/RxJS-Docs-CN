...
@Component({
  selector: 'app-operator-toc',
  templateUrl: './operator-toc.component.html',
  styleUrls: ['./operator-toc.component.scss']
})
export class OperatorTocComponent implements OnInit, OnDestroy {
  @Input() links: Link[] = [];
  @Input() container: string;
  @Input() headerSelectors = '.operator-header,.operator-subheader';
